        ...
        child: Padding(
          ...
          child: Column(
            children: <Widget>[
              ...
              TextField(
                onSubmitted: (value) => _onMarginChanged(value, ShellEdge.edgeTop),
                keyboardType: TextInputType.number,
                inputFormatters: [FilteringTextInputFormatter.digitsOnly],
                decoration: const InputDecoration(labelText: 'Top'),
              ),
              TextField(
                onSubmitted: (value) => _onMarginChanged(value, ShellEdge.edgeLeft),
                keyboardType: TextInputType.number,
                inputFormatters: [FilteringTextInputFormatter.digitsOnly],
                decoration: const InputDecoration(labelText: 'Left'),
              ),
              TextField(
                onSubmitted: (value) => _onMarginChanged(value, ShellEdge.edgeRight),
                keyboardType: TextInputType.number,
                inputFormatters: [FilteringTextInputFormatter.digitsOnly],
                decoration: const InputDecoration(labelText: 'Right'),
              ),
              TextField(
                onSubmitted: (value) => _onMarginChanged(value, ShellEdge.edgeBottom),
                keyboardType: TextInputType.number,
                inputFormatters: [FilteringTextInputFormatter.digitsOnly],
