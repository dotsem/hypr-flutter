      ...
      children: [
        ...
        SegmentedButton(
          segments: const <ButtonSegment<ShellKeyboardMode>>[
            ButtonSegment<ShellKeyboardMode>(value: ShellKeyboardMode.keyboardModeNone, label: Text('None')),
            ButtonSegment<ShellKeyboardMode>(value: ShellKeyboardMode.keyboardModeExclusive, label: Text('Exclusive')),
            ButtonSegment<ShellKeyboardMode>(value: ShellKeyboardMode.keyboardModeOnDemand, label: Text('OnDemand')),
          ],
          selected: {kbMode},
