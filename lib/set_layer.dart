      ...
      children: [
        ...
        SegmentedButton(
          segments: const <ButtonSegment<ShellLayer>>[
            ButtonSegment<ShellLayer>(value: ShellLayer.layerBackground, label: Text('Background')),
            ButtonSegment<ShellLayer>(value: ShellLayer.layerBottom, label: Text('Bottom')),
            ButtonSegment<ShellLayer>(value: ShellLayer.layerTop, label: Text('Top')),
            ButtonSegment<ShellLayer>(value: ShellLayer.layerOverlay, label: Text('Overlay')),
          ],
